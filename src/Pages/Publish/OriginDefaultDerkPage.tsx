                            ...
                            <div className="flex flex-row justify-start">
                                ...
                                <div className="messages text-sm text-gray-700 grid grid-flow-row gap-2">
                                    <div className="flex items-center group">
                                        ...
                                        <button
                                            type="button"
                                            className="group-hover:block flex flex-shrink-0 focus:outline-none mx-2 rounded-full text-gray-500 hover:text-gray-900 hover:bg-gray-700 bg-gray-800 w-8 h-8 p-2">
...
export default OriginDefaultDerkPage;
