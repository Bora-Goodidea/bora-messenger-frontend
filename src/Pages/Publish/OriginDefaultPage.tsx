                    ...
                    <section className="flex flex-col flex-none overflow-auto w-24 lg:max-w-sm md:w-2/5 transition-all duration-300 ease-in-out">
                        ...
                        <div className="contacts p-2 flex-1 overflow-y-scroll">
                            ...
                            <div className="flex justify-between items-center p-3 hover:bg-gray-100 rounded-lg relative">
                                ...
                                <div className="bg-blue-500 w-3 h-3 rounded-full flex flex-shrink-0 md:block"></div>
                            </div>
                            ...
                            <div className="flex justify-between items-center p-3 hover:bg-gray-100 rounded-lg relative">
                                ...
                                <div className="w-4 h-4 flex flex-shrink-0 md:block">
                                    <img
                                        className="rounded-full w-full h-full object-cover"
                                        alt="user2"
                                        src="https://randomuser.me/api/portraits/women/23.jpg"
                            ...
                            <div className="flex flex-row justify-start">
                                ...
                                <div className="messages text-sm text-gray-700 grid grid-flow-row gap-2">
                                    <div className="flex items-center group">
                                        ...
                                        <button
                                            type="button"
                                            className="group-hover:block flex flex-shrink-0 focus:outline-none mx-2 rounded-full text-gray-500 hover:text-gray-800 hover:bg-gray-200 bg-gray-100 w-8 h-8 p-2">
...
C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"
                                    ...
                                    <div className="flex items-center group">
                                        <p className="px-6 py-3 rounded-b-full rounded-r-full bg-gray-100 max-w-xs lg:max-w-md">
                                            ...
                                            labore et dolore magna aliqua. Volutpat lacus laoreet non curabitur gravida.
                                        </p>
                                        <button
                                            type="button"
                                            className="group-hover:block flex flex-shrink-0 focus:outline-none mx-2 rounded-full text-gray-500 hover:text-gray-800 hover:bg-gray-200 bg-gray-100 w-8 h-8 p-2">
...
export default OriginDefaultPage;
